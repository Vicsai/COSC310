...
<div class="jumbotron">
	...
	<select name = "year" class="form-control">
		...
		<h4>Income</h4></br>
		<input type="text" name="income" placeholder="Enter Amount Here" class="form-control"><br>

		<h4>Rent</h4></br>
		<input type="text" name="rent" placeholder="Enter Amount Here" class="form-control"><br>

		<h4>Food</h4></br>
		<input type="text" name="food" placeholder="Enter Amount Here" class="form-control"><br>

		<h4>Clothing</h4></br>
		<input type="text" name="clothing" placeholder="Enter Amount Here" class="form-control"><br>

		<h4>Entertainment</h4></br>
		<input type="text" name="entertainment" placeholder="Enter Amount Here" class="form-control"><br>
